...
//    }
    ...
    public GMethod overrideMethod(Symbol.MethodSymbol methodSymbol, boolean addSupperCall) {
        ...
        String typeName = methodSymbol.getReturnType().asElement().flatName().toString();
        ...
        for (Type paramType : methodSymbol.asType().getParameterTypes()) {
            ...
            JCExpression returnTypeName = getEnvironment().createParser(paramType.asElement().flatName().toString()).parseType();
