...
import net.xkor.genaroid.plugin.GenaroidPlugin;
...
public class GenaroidProcessor extends AbstractProcessor {
    ...
    private ArrayList<GenaroidPlugin> plugins;
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        try {
            ...
            for (GenaroidPlugin plugin : plugins) {
                long pluginStartTime = System.currentTimeMillis();
                plugin.process(genaroidEnvironment);
    ...
    public Set<String> getSupportedAnnotationTypes() {
        ...
        for (GenaroidPlugin processor : plugins) {
